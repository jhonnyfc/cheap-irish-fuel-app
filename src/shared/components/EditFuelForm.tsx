...
export default function EditFuelForm({ station }: EditFuelFormProps) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 mt-6">
      <h3 className="text-xl font-bold text-gray-800 dark:text-zinc-100 mb-4 flex items-center gap-2">
        <svg
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border dark:border-zinc-700 bg-white dark:bg-zinc-800 text-gray-900 dark:text-zinc-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all"
